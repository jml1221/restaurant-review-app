...
public class Main {
                    ...
                    while(userChoice != 4) {
                        ...
                        switch(userChoice) {
                            ...
                            case 3:
                                ...
                                Restaurant restaurant = user.getRestaurant(restaurantList, kb.nextLine());
                                if(restaurant == null) {
    ...
    public static void browseRestaurantAddReview(User user, Scanner kb, RestaurantList restaurantList) {
